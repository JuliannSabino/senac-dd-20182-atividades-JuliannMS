...
public class AlunoBO {
	...
	public double calcularMediaFinal(Aluno aluno){
		double mediaP = ((aluno.getNotaProva1() + aluno.getNotaProva2()) * (aluno.getPesoProvas())/100) / 2;
		double mediaT = ((aluno.getNotaTrabalho1() + aluno.getNotaTrabalho2()) * (aluno.getPesoTrabalhos())/100) / 2;
	...
	public boolean verificaPorMatricula(String matricula) {
		return this.aDAO.verificaPorMatricula(matricula);
	}	
}
